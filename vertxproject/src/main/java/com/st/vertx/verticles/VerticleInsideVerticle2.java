 ...
 */
public class VerticleInsideVerticle2 extends AbstractVerticle {

	@Override
	public void start(Future<Void> startFuture) {
		System.out.println("VerticleInsideVerticle2 started!");
	}

	@Override
	public void stop(Future stopFuture) throws Exception {
		System.out.println("VerticleInsideVerticle2 stopped!");
	}
