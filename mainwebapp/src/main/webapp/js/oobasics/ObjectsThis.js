/**
 * This represents the global Object, in case of Browsers, it is the window
 * object. When a function is called while attached to an object, this is to
 * equal to the object by default
 */

define([ "utils/customConsole", "utils/commonUtils" ],
		function(customConsole, commonUtils) {
			...
			/**
			 * Changing this. call() --> Executes the Function with the Object
			 * you would like to call it for. apply() --> Similar to call, but
			 * an array of Objects can be passed bind() --> Binds an function to
			 * an object and returns a function, which can then be called w/o
			 * every changing the value of this.
			 */
			...
			// Adding a Function to the person2 and assigning the value
			// sayNameForPerson1, doesn't change the value of this.
