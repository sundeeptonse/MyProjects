...
public class MMC {
	...
	public static void main(String[] args) {
		...
		//Cannot be Type Casted to anything incorrect, will throw Compile Time Exception
		isGen.getValue();
		
		//CustomExtendsA<String> x = new CustomExtendsA<>();
		CustomExtendsA<Float> x = new CustomExtendsA<>();
		
		CustomExtendsB<ArrayList<String>> customExtendsb = new CustomExtendsB<>();
		//Complile Time error
		//CustomExtendsB2<ArrayList<String>> customExtendsb2 = new CustomExtendsB2<>();
		CustomExtendsB3<ArrayList<String>> customExtendsb3 = new CustomExtendsB3<>();
		
		CustomExtendsB4<ArrayList<Object>> customExtendsb4 = new CustomExtendsB4<>();
