...
public class EnumTest {
	public enum Company {
		EBAY(30), PAYPAL(10,20), GOOGLE(15,20), YAHOO(20,20), ATT(25,25), SUNDEEP(50, 60,70);
		private int value1;
		private int value2;
		private int value3;
	...
	public static void main(String[] args) {
		for (Company cName : Company.values()) {
			System.out.println("Company Value1: " + cName.value1 + "cName.value2:" + cName.value2 + ":cName.value3:" + cName.value3 + " - Comapny Name: " + cName);
		}
		if(Company.EBAY.equals("EBAY")){
			System.out.println("Ehll");
			System.out.println(Company.EBAY.value1 + "::" + Company.EBAY.value2);
		}
	}
}
